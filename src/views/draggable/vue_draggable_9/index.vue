<template>
  <div class="container">
    <Breadcrumb :items="['元素拖拽', '禁止拖拽排序（vue.draggable.next）']" />

    <a-card class="text">
      禁止拖拽排序，分组间可以拖拽，分组内禁止拖拽排序。
    </a-card>

    <a-card class="general-card">
      <a-row>
        <a-col :span="6" class="box-1">
          <draggable :list="list_1" animation="300" :group="{ name: 'people', pull: true, put: true }"
            :force-fallback="true" :ghost-class="ghostClass" :chosen-class="chosenClass" :drag-class="dragClass"
            :disabled="disabled_1" :sort="false">
        ...
        <a-col :span="6" class="box-2">
          <draggable :list="list_2" animation="300" :group="{ name: 'people', pull: true, put: true }"
            :force-fallback="true" :ghost-class="ghostClass" :chosen-class="chosenClass" :drag-class="dragClass"
            :disabled="disabled_2" :sort="false">
